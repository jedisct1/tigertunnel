...
pub fn build(b: *std.Build) void {
    ...
    const mod = b.addModule("tigertunnel", .{
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            ...
            // root module.
            .imports = &.{
                // Here "tigertunnel" is the name you will use in your source code to
                // import this module (e.g. `@import("tigertunnel")`). The name is
                // repeated because you are allowed to rename your imports, which
                // can be extremely useful in case of collisions (which can happen
                // importing modules from different packages).
                .{ .name = "tigertunnel", .module = mod },
            },
        }),
    });
    ...
    const test_client = b.addExecutable(.{
        .name = "test_client",
        .root_module = b.createModule(.{
            .root_source_file = b.path("src/tests/test_client.zig"),
            .target = target,
            .optimize = optimize,
        }),
    });
    ...
    const test_client_step = b.step("test-client", "Run test client");
    ...
    const stress_test_step = b.step("stress-test", "Run stress tests");
